            ...
            <React.Fragment>
                <Dropdown isOpen={this.state.menu} toggle={this.toggle} className="d-inline-block user-dropdown">
                    <DropdownToggle tag="button" className="btn header-item waves-effect" id="page-header-user-dropdown">
                        ...
                        <span className="d-none d-xl-inline-block ms-1 text-transform">User</span>
                    ...
                    <DropdownMenu className="dropdown-menu-end">
                        ...
                        <DropdownItem className="d-block" href="#"><span className="badge badge-success float-end mt-1"></span><i className="ri-settings-2-line align-middle me-1"></i> {this.props.t('Settings')}</DropdownItem>
